...
mixin _$ProfileScreenState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String? errorMessage, ScreenStatus status)? initial,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $ProfileScreenStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? errorMessage, ScreenStatus status});
}
...
class __$$_InitialCopyWithImpl<$Res>
    extends _$ProfileScreenStateCopyWithImpl<$Res, _$_Initial>
...
class _$_Initial implements _Initial {
  const _$_Initial({this.errorMessage, this.status = ScreenStatus.init});
  ...
  @override
  String toString() {
    return 'ProfileScreenState.initial(errorMessage: $errorMessage, status: $status)';
  }
...
abstract class _Initial implements ProfileScreenState {
  const factory _Initial(
      {final String? errorMessage, final ScreenStatus status}) = _$_Initial;
